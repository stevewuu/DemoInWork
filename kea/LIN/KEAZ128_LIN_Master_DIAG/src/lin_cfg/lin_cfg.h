...
#define MAX_LENGTH_SERVICE 12

#define MAX_QUEUE_SIZE 3


#define _BootProtocol_DIAG_NUMBER_OF_SERVICES_    10

#define BootProtocol_DIAGSRV_READ_BY_IDENTIFIER_ORDER    0

#define BootProtocol_DIAGSRV_SAVE_CONFIGURATION_ORDER    1

#define BootProtocol_DIAGSRV_ASSIGN_FRAME_ID_RANGE_ORDER    2

#define BootProtocol_DIAGSRV_READ_DATA_BY_IDENTIFIER_ORDER    3

#define BootProtocol_DIAGSRV_SESSION_CONTROL_ORDER    4

#define BootProtocol_DIAGSRV_IO_CONTROL_BY_IDENTIFIER_ORDER    5

#define BootProtocol_DIAGSRV_FAULT_MEMORY_READ_ORDER    6

#define BootProtocol_DIAGSRV_FAULT_MEMORY_CLEAR_ORDER    7

#define BootProtocol_DIAGSRV_ROUTINECONTROL_ORDER    8

#define BootProtocol_DIAGSRV_ASSIGN_FRAME_IDENTIFIER_ORDER    9
