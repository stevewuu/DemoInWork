...
const l_u8 BootProtocol_lin_diag_services_supported[_BootProtocol_DIAG_NUMBER_OF_SERVICES_] = {0xB2,0xB7};
l_u8 BootProtocol_lin_diag_services_flag[_BootProtocol_DIAG_NUMBER_OF_SERVICES_] = {0,0};
...
lin_tl_descriptor lin_tl_desc[LIN_NUM_OF_IFCS] = {
   ...
   /* interface_name = BootProtocol */
   {
   &tx_single_pdu_data[BootProtocol],          /* *pointer to transmit queue on TL */
   &rx_single_pdu_data[BootProtocol],          /* *pointer to receive queue on TL */
